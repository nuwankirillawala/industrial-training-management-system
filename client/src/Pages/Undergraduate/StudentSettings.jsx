...
export const StudentSettings = () => {
    ...
    const getStudentData = async () => {
        try {
            const res = await axios.get("http://localhost:5000/api/v1/undergraduate/profile", { withCredentials: true });
            if (res.status === 200) {
    ...
    const handleFormSubmit = async (values) => {
        ...
        try {
            const res = await axios.patch(
                "http://localhost:5000/api/v1/undergraduate/profile", { withCredentials: true },
                {
    ...
    return (
        ...
        <Grid container spacing={1}>
            ...
            <Grid item md={12}>
                <Stack>
                    <Typography variant="head3" marginBottom={'5px'}>Update Your Profile</Typography>
                </Stack>
            </Grid>
            ...
            <Grid item md={3}>
                ...
                <Stack direction='column' spacing={1}>
                    <Tile>
                        ...
                        <Stack>
                            <ChangeAvatar 
                            sumbitProfileImage={"http://localhost:5000/api/v1/undergraduate/profile/image"}
                            getProfileImage={"http://localhost:5000/api/v1/undergraduate/profile"}
                            />
                        </Stack>
                    </Tile>
